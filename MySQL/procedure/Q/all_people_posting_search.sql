...
where FOF_result.creator_name = posting.creator_name and view_priority>=2 and textfile like (@keyword) )# seaching the specific keywords;
...
(select posting.*
 ...
 where creator_name not in( select *
      ...
      and view_priority>=3 # this posting's viewing priority should be anyone
      and textfile like (@keyword) );
 
#FOF_result.creator_name = posting.creator_name and view_priority>=2 and textfile like (@keyword) )# seaching the specific keywords;
